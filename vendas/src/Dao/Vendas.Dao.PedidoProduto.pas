...
type
  ...
  public
    ...
    function LerPedidoProduto(FDMemPedido: TFDMemTable; nNumPedido : Integer) : Boolean;
...
function TPedidoProdutoDao.LerPedidoProduto(FDMemPedido: TFDMemTable; nNumPedido : Integer) : Boolean;
var
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        Self.GravarPedidoProduto(PedidoProduto);
      except
        on ex:exception do
        begin
          Result := false;
